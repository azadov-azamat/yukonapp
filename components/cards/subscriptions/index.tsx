...
const Subscriptions: React.FC<SubscriptionProps> = ({subscription}) => {
    ...
    return (
        <View className="w-full max-w-md p-6 mb-4 bg-white border border-blue-200 rounded-lg shadow-sm">
            <View className="flex-row items-center justify-between mb-6">
                <Text className="text-xl font-bold text-gray-800">{getName(subscription.plan, 'name')}</Text>
            ...
            <View className="p-4 mb-6 rounded-lg bg-blue-50">
                <View className="flex-row items-start gap-3">
                    ...
                    <Text className="flex-1 text-gray-700">{getName(subscription.plan, 'description')}</Text>
                </View>
            </View>
